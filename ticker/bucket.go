...
// stops the ticker, false if the ticker has already expired or been stopped.
//
// If the ticker t has already expired and the t.task has been started in its own
